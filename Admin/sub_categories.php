...
$total = mysqli_num_rows(mysqli_query($con,"SELECT sub_categories.*,categories.Categories FROM sub_categories,categories  WHERE categories.id = sub_categories.categories_id order by sub_categories desc"));

$page = ceil($total/$per_page);

$sql = "SELECT sub_categories.*,categories.Categories FROM sub_categories,categories  WHERE categories.id = sub_categories.categories_id order by sub_categories desc  LIMIT $start,$per_page";

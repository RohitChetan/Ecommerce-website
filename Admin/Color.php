...
if(isset($_GET['type']) && $_GET['type'] !=''){
   ...
   if($type=='status'){
      ...
      $update = "UPDATE color SET status='$status' WHERE id='$id'";
...
$total = mysqli_num_rows(mysqli_query($con,"SELECT color.*,sub_categories.sub_categories FROM color,sub_categories  WHERE color.Sub_category_id = sub_categories.id order by color desc"));

$page = ceil($total/$per_page);

$sql = "SELECT color.*,sub_categories.sub_categories FROM color,sub_categories  WHERE color.Sub_category_id = sub_categories.id order by id desc  LIMIT $start,$per_page";
                     ...
                     <div class="col-xl-12">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <h4 class="box-link"><a href="Add_color.php"> Add Color </a></h4>
                           </div>
                           <div class="card-body--">

...
?>
 ...
 <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/Cart_image.png) no-repeat scroll center center / cover ;">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <br/> <a href="javascript:void(0)" onclick="Manage_cart('<?php echo $key ?>',
                                            'update')"> Update </a>
                                            </td>
